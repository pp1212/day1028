...
public class MyFrame extends JFrame implements ActionListener{
	...
	public MyFrame() {
		...
		JMenuItem draw_color = new JMenuItem("색상");
		...
		draw_color.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(cmd.equals("저장")) {
			...
			Color selectedColor = chooser.showDialog(null, "색상", Color.YELLOW);
			if(selectedColor != null) {
				lp.setForeground(selectedColor);
			}
		}
